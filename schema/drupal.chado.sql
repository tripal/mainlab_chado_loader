...
--
-- Name: analysis; Type: TABLE; Schema: chado; Owner: -; Tablespace: 
--
...
--
-- Name: analysis_analysis_id_seq; Type: SEQUENCE; Schema: chado; Owner: -
--
...
--
-- Name: analysis_analysis_id_seq; Type: SEQUENCE OWNED BY; Schema: chado; Owner: -
--
...
--
-- Name: analysisfeature; Type: TABLE; Schema: chado; Owner: -; Tablespace: 
--
...
--
-- Name: analysisfeature_analysisfeature_id_seq; Type: SEQUENCE; Schema: chado; Owner: -
--
...
--
-- Name: analysisfeature_analysisfeature_id_seq; Type: SEQUENCE OWNED BY; Schema: chado; Owner: -
--
...
--
-- Name: cvterm_image_cvterm_image_id_seq; Type: SEQUENCE OWNED BY; Schema: chado; Owner: -
--
...
--
-- Name: feature_nd_geolocation_feature_nd_geolocation_id_seq; Type: SEQUENCE OWNED BY; Schema: chado; Owner: -
--
...
--
-- Name: cvterm_image_id; Type: DEFAULT; Schema: chado; Owner: -
--
...
--
-- Name: feature_nd_geolocation_id; Type: DEFAULT; Schema: chado; Owner: -
--
...
--
-- Name: cvterm_image_a_pkey; Type: CONSTRAINT; Schema: chado; Owner: -; Tablespace: 
--

ALTER TABLE ONLY cvterm_image
    ADD CONSTRAINT cvterm_image_a_pkey PRIMARY KEY (cvterm_image_id);


--
-- Name: cvterm_image_cvterm_id_eimage_id_key; Type: CONSTRAINT; Schema: chado; Owner: -; Tablespace: 
--

ALTER TABLE ONLY cvterm_image
    ADD CONSTRAINT cvterm_image_cvterm_id_eimage_id_key UNIQUE (cvterm_id, eimage_id);
...
ALTER TABLE ONLY feature_nd_geolocation
    ADD CONSTRAINT feature_nd_geolocation_pkey PRIMARY KEY (feature_nd_geolocation_id);
...
--
-- Name: cvterm_image_cvterm_id_fkey; Type: FK CONSTRAINT; Schema: chado; Owner: -
--

ALTER TABLE ONLY cvterm_image
    ADD CONSTRAINT cvterm_image_cvterm_id_fkey FOREIGN KEY (cvterm_id) REFERENCES cvterm(cvterm_id) ON DELETE CASCADE;


--
-- Name: cvterm_image_eimage_id_fkey; Type: FK CONSTRAINT; Schema: chado; Owner: -
--

ALTER TABLE ONLY cvterm_image
    ADD CONSTRAINT cvterm_image_eimage_id_fkey FOREIGN KEY (eimage_id) REFERENCES eimage(eimage_id) ON DELETE CASCADE;
